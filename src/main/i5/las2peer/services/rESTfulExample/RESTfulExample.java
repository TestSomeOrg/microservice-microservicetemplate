...
@Api
@SwaggerDefinition(info = @Info(title = "microservicetemplate", version = "1.0", description = "A las2peer microservice generated by the CAE.", termsOfService = "none", contact = @Contact(name = "", email = "CAEAddress@gmail.com"), license = @License(name = "BSD", url = "https://github.com/TestSomeOrg/microservice-microservicetemplate/blob/master/LICENSE.txt")))
...
public class RESTfulExample extends RESTService {
  ...
  public Response postTrack(String track) {
    JSONObject track_JSON = (JSONObject) JSONValue.parse(track);
  ...
  public Response getTrack(String track) {
    JSONObject track_JSON = (JSONObject) JSONValue.parse(track);
