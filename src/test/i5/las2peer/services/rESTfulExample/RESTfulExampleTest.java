...
/**
 *
 * microservicetemplate - Test Class
 *
 * This class provides a basic testing framework for the microservice microservicetemplate. It was
...
public class RESTfulExampleTest {
  ...
  public void testpostTrack() {
    ...
    try {
      ...
      ClientResponse result = c.sendRequest("POST", mainPath + "/postTrack", track.toJSONString(),
  ...
  public void testgetTrack() {
    ...
    try {
      JSONObject track = new JSONObject();
      c.setLogin(testAgent.getIdentifier(), testPass);
      ClientResponse result = c.sendRequest("GET", mainPath + "/getTrack/{trackId}", track.toJSONString(),
        MediaType.APPLICATION_JSON, MediaType.APPLICATION_JSON, new HashMap<String,String>());
      assertTrue(true); // change here
